...
function loadStatsPage(){       
                        var x = document.getElementById("stats_table"), sumVal=0;
                        
                        var diff=0;
                        for(var i = 2; i < x.rows.length; i++){
                                var y = parseInt(x.rows[i].cells[2].innerHTML);
                                var z = parseInt(x.rows[i].cells[3].innerHTML);
			...
			b.innerHTML = sumVal;
			var c = document.getElementById("losses");
         		c.innerHTML = diff;               
